<%@ Page Title="" Language="C#" MasterPageFile="~/Application.master" AutoEventWireup="true" Inherits="Kisan.Demonstration.TargetReleasehoa" Codebehind="TargetReleasehoa.aspx.cs" %>
                        ...
                        <div class="body scheme_body">
                            <div class="demo-masked-input">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <label for="email_address">Total Target Released Amount<span class="star_color"> * </span> </label>
                                            <div class="form-group">
