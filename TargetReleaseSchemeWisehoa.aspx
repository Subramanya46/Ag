<%@ Page Title="" Language="C#" MasterPageFile="~/Application.master" AutoEventWireup="true" Inherits="Kisan.Demonstration.TargetReleaseSchemeWisehoa" CodeBehind="TargetReleaseSchemeWisehoa.aspx.cs" %>
            ...
            <div class="row clearfix">
                        ...
                        <div class="body scheme_body">
                            <div class="demo-masked-input">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlDistrict" class="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged">
                                                </asp:DropDownList>
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <%--<asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterMode="ValidChars" FilterType="Numbers"
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <%--<asp:RequiredFieldValidator ID="rfvtxtDescription" runat="server" ErrorMessage="Enter Description" ValidationGroup="valSel"
                                                    ControlToValidate="txtDescription" InitialValue="" CssClass="margin_label" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group">
                                            <label for="email_address">Total Physical Target Released </label>
                                            <div class="form-group">
                                                <asp:Label ID="lblTotalPhysicalTargetReleased" class="form-control" runat="server" ReadOnly="true">
                                                </asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="input-group">
                                            <label for="email_address">Total Target Released Amount</label>
                                            <div class="form-group">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-1">
                                        <div class="input-group">
                                            ...
                                            <asp:Label runat="server" ID="lblcategory1" for="email_address"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="input-group">
                                            <label for="email_address">Total Physical Target Released </label>
                                            <div class="form-group">
                                                <asp:Label ID="lblTotalPhysicalTargetReleased1" class="form-control" runat="server" ReadOnly="true">
                                                </asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-1">
                                        <div class="input-group">
                                            ...
                                            <asp:Label runat="server" ID="lblcategory2" for="email_address"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="input-group">
                                            <label for="email_address">Total Physical Target Released </label>
                                            <div class="form-group">
                                                <asp:Label ID="lblTotalPhysicalTargetReleased2" class="form-control" runat="server" ReadOnly="true">
                                                </asp:Label>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row clearfix" runat="server" id="divReleasedList">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card card_top">
                            <div class="header header_padding">
                                <h2 class="heading_padding">
                                    <span class="scheme_master">Amount Released Transaction List</span>
                                </h2>
                            </div>
                            <div class="body scheme_body">
                                <div class="demo-masked-input">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label runat="server" ID="Label1" Text='<%# (grdReleasedList.PageSize * grdReleasedList.PageIndex) + Container.DisplayIndex+1 %>'></asp:Label>
                                                        ...
                                                        <asp:TemplateField HeaderText="Scheme" ItemStyle-HorizontalAlign="center">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblScheme" Text='<%# Eval("MainSchemeName") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Sub Scheme" ItemStyle-HorizontalAlign="center">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblSubScheme" Text='<%# Eval("SchemeName") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Released Date" ItemStyle-HorizontalAlign="center">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblCreated" Text='<%# Eval("CreatedOn") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    <EmptyDataTemplate>
                ...
                <div class="modal fade in" id="myModal_Delete" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content" runat="server">
                            ...
                            <div class="modal-body body_model">
                                <p class="p_model">
                                    Are sure want to delete Traget released amount . Once you delete can not revert back ! 
                                </p>
                            </div>
                            <div class="modal-footer">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content" runat="server">
                        ...
                        <div class="modal-body body_model">
                            <p class="p_model">
                                Record can't be deleted, Because JDA already created targets!
                            </p>
                        </div>
                        <div class="modal-footer">
                            <asp:Button runat="server" Text="Close" class="btn btn-default deflt_btn" data-dismiss="modal"></asp:Button>
