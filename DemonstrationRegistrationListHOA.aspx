<%@ Page Title="" Language="C#" MasterPageFile="~/Application.master" AutoEventWireup="true" CodeBehind="DemonstrationRegistrationListHOA.aspx.cs" Inherits="KKISANWEB.Demonstration.DemonstrationRegistrationListHOA" EnableEventValidation="false" %>
                        ...
                        <div class="body scheme_body">
                            <div class="demo-masked-input">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-2">
                                        <label>District <span class="star_color">*</span> </label>
                                        <div class="form-group">
                                            <div class="form-line">
                                    ...
                                    <div class="col-md-2">
                                        <label>Taluk <span class="star_color">*</span> </label>
                                        <div class="form-group">
                                            <div class="form-line">
                                    ...
                                    <div class="col-md-2">
                                        <div class="input-group">
                                            <label for="email_address">Application Status <span class="star_color">* </span></label>
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            ...
                                            <asp:GridView ID="grdFarmerAcceptance" runat="server" AutoGenerateColumns="false" CellPadding="2" CellSpacing="2"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="SI NO." ItemStyle-HorizontalAlign="center">
                                                        <ItemTemplate>
