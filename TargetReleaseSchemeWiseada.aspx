<%@ Page Title="" Language="C#" MasterPageFile="~/Application.master" AutoEventWireup="true" CodeBehind="TargetReleaseSchemeWiseada.aspx.cs" Inherits="KKISANWEB.Demonstration.TargetReleaseSchemeWiseada" %>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-2" runat="server">
                                        <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlTaluk" class="form-control" runat="server" >
                                                </asp:DropDownList>
                                    ...
                                    <div class="col-md-2" runat="server">
                                        <div class="input-group">
                                            <label for="email_address">RSK <span class="star_color">* </span></label>
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlHobli" class="form-control" OnSelectedIndexChanged="ddlHobli_SelectedIndexChanged" AutoPostBack="true" runat="server" >
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="rfvddlHobli" runat="server" ErrorMessage="Select Taluk" ValidationGroup="valSel"
                                                    ControlToValidate="ddlHobli" InitialValue="0" CssClass="margin_label" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-1">
                                        <div class="input-group">
                                            ...
                                            <asp:Label runat="server" ID="Label7" for="email_address"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="input-group">
                                            <label for="email_address">Physical Target Released by JDA</label>
                                            <div class="form-group">
                                     ...
                                     <div class="col-md-2">
                                        <div class="input-group">
                                            <label for="email_address">Target Amount Released by JDA</label>
                                            <div class="form-group">
                                                ...
                                                <Columns>
                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                       ...
                                                       <ItemTemplate>
                                                           ...
                                                           <asp:HiddenField runat="server" ID="hdnHobliID" Value='<%# Bind("HobliID") %>' />
                                                    ...
                                                    <asp:TemplateField HeaderText="RSK" ItemStyle-HorizontalAlign="center">
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" ID="lblHobli" Text='<%# Eval("HobliName") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Physical Target" ItemStyle-HorizontalAlign="center">
                                                        <ItemTemplate>
