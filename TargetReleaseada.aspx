<%@ Page Title="" Language="C#" MasterPageFile="~/Application.master" AutoEventWireup="true" Inherits="Kisan.Demonstration.TargetReleaseada" Codebehind="TargetReleaseada.aspx.cs" %>
                        ...
                        <div class="body scheme_body">
                            <div class="demo-masked-input">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <label for="email_address">Total Target Amount Released by ADA </label>
                                            <div class="form-group">
                                ...
                                <div class="row clearfix">
                                   ...
                                   <%-- <div class="col-md-3">
                                        <div class="input-group">
                                                     <asp:Label ID="lbladdfinacialtarget" runat="server" Text="Add  Financial Target" Enabled="false" ForeColor="#000"></asp:Label>
                                          <%--<label for="email_address">Add  Financial Target<span class="star_color">* </span></label>--%>
                                           <%-- <div class="form-group">
                                                <asp:TextBox ID="txtaddfinacialtaget" class="form-control" runat="server">
                                                </asp:TextBox>--%>
                                                <%--<asp:RequiredFieldValidator ID="rfvtxtFinancialTarget" runat="server" ErrorMessage="Enter Financial Target" ValidationGroup="valSel"
                                                    ControlToValidate="txtFinancialTarget" InitialValue="" CssClass="margin_label" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                                                <%--<asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterMode="ValidChars" ValidChars="{1,2,3,4,5,6,7,8,9,0,.}"
                                                    TargetControlID="txtFinancialTarget">
                                                </asp:FilteredTextBoxExtender>--%>
                                            <%--</div>
                                        </div>
