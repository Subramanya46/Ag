...
{
    public partial class TargetReleaseSchemeWiseada : System.Web.UI.Page
    {
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Page.IsValid == true )
                {
                    ...
                    Double HOAAmount_New1 = Convert.ToDouble(Common.TotalTargetReleaseAmountDBT2122(ApplicationID, Convert.ToInt32(ddlFinancialYear.SelectedValue), Convert.ToInt32(ddlScheme.SelectedValue), Convert.ToInt32(ddlSubScheme.SelectedValue), Convert.ToInt32(ddlCrop.SelectedValue), Convert.ToInt32(ddlTechnology.SelectedValue), Convert.ToInt32(ddlCategory1.SelectedValue), Convert.ToInt32(ddlDistrict.SelectedValue), Convert.ToInt32(ddlTaluk.SelectedValue), 0, 95, "kkisanconstr"));
                    Double JDAAmount_New1 = Convert.ToDouble(Common.TotalTargetReleaseAmountDBT2122(ApplicationID, Convert.ToInt32(ddlFinancialYear.SelectedValue), Convert.ToInt32(ddlScheme.SelectedValue), Convert.ToInt32(ddlSubScheme.SelectedValue), Convert.ToInt32(ddlCrop.SelectedValue), Convert.ToInt32(ddlTechnology.SelectedValue), Convert.ToInt32(ddlCategory1.SelectedValue), Convert.ToInt32(ddlDistrict.SelectedValue), Convert.ToInt32(ddlTaluk.SelectedValue), Convert.ToInt32(ddlHobli.SelectedValue), Convert.ToInt32(Session["RoleID"].ToString()), "kkisanconstr"));
                    ...
                    if (btnGo.Text == "Update GEN" || btnGo.Text == "Update SCP" || btnGo.Text == "Update TSP")
                    {
                        ...
                        if (HOAAmount_New >= Convert.ToDouble(String.Format("{0:0.000}", (JDAAmount_New - temp_JDAAmount_New + Release_New))))
                        {
                            if (HOAPhysical_New >= Convert.ToDouble(String.Format("{0:0.000}", (JDAPhysical_New - temp_JDAPhysical_New + ReleasePhysical_New))))
                            {
                                ...
                                string[] parval = { ViewState["hdnApplicationID"].ToString(), ViewState["hdnFinancialYearID"].ToString(), ViewState["hdnMainSchemeID"].ToString(), ViewState["hdnSchemeID"].ToString(), ViewState["hdnCropID"].ToString(), ViewState["hdnTechnologyID"].ToString(), ViewState["hdnCategoryID"].ToString(), ViewState["hdnDistrictID"].ToString(), ViewState["hdnTalukID"].ToString(), ViewState["hdnHobliID"].ToString(), hectare, amount, Session["RoleID"].ToString(), txtOrderNo.Text.Trim(), txtDescription.Text.Trim(), "Update" };
                            ...
                            {
                                lblNotMsg.Text = " ADA Physical Targets Release Should be less than JDA Physical Targets Release ! ";
                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "showNotModal();", true);
                                BindSchemeReleaseTransactionList();
                            }
                        }
                        ...
                        if (txtPhysicalTarget.Text != "" && txtFinancialTarget.Text != "")
                        {
                            ...
                            if (HOAAmount_New >= Convert.ToDouble(String.Format("{0:0.000}", (JDAAmount_New + Release_New))))
                            {
                                if (HOAPhysical_New >= Convert.ToDouble(String.Format("{0:0.000}", (JDAPhysical_New + ReleasePhysical_New))))
                                {
                                    ...
                                    string[] par = { "@ApplicationID", "@FinancialYearID", "@MainSchemeID", "@SchemeID", "@CropID", "TechnologyID", "CategoryID", "@DistrictID", "@TalukID", "@HobliID", "@PhysicalTarget", "@FinancialTarget", "@ReleasedBy", "@OrderNo", "@Description", "@Method" };
                                        string[] parval = { ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue, ddlSubScheme.SelectedValue, ddlCrop.SelectedValue, ddlTechnology.SelectedValue, ddlCategory.SelectedValue, ddlDistrict.SelectedValue, ddlTaluk.SelectedValue, ddlHobli.SelectedValue, txtPhysicalTarget.Text.Trim(), txtFinancialTarget.Text.Trim(), Session["RoleID"].ToString(), txtOrderNo.Text.Trim(), txtDescription.Text.Trim(), "insert" };
                                         res = res+ QueryExecution.ExeData("SP", "[DBT].[SP@SchemeTargetRelease2122]", par, parval, "kkisanconstr");

                                }
                                else
                                {
                                    lblNotMsg.Text = " ADA Physical Targets Release for GEN Should be less than JDA Physical Target Release for GEN ! ";
                                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "showNotModal();", true);
                                    BindSchemeReleaseTransactionList();
                                }
                            }
                            ...
                            {
                                lblNotMsg.Text = " ADA Targets Release Amount for GEN Should be less than JDA Target Release Amount for GEN ! ";
                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "showNotModal();", true);
                                BindSchemeReleaseTransactionList();
                            }
                        }
                        if (txtPhysicalTarget1.Text != "" && txtFinancialTarget1.Text != "")
                        {
                            ...
                            if (HOAAmount_New1 >= Convert.ToDouble(String.Format("{0:0.000}", (JDAAmount_New1 + Release_New1))))
                            {
                                if (HOAPhysical_New1 >= Convert.ToDouble(String.Format("{0:0.000}", (JDAPhysical_New1 + ReleasePhysical_New1))))
                                {
                                    ...
                                    string[] par = { "@ApplicationID", "@FinancialYearID", "@MainSchemeID", "@SchemeID", "@CropID", "TechnologyID", "CategoryID", "@DistrictID", "@TalukID", "@HobliID", "@PhysicalTarget", "@FinancialTarget", "@ReleasedBy", "@OrderNo", "@Description", "@Method" };
                                    string[] parval = { ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue, ddlSubScheme.SelectedValue, ddlCrop.SelectedValue, ddlTechnology.SelectedValue, ddlCategory1.SelectedValue, ddlDistrict.SelectedValue, ddlTaluk.SelectedValue, ddlHobli.SelectedValue, txtPhysicalTarget1.Text.Trim(), txtFinancialTarget1.Text.Trim(), Session["RoleID"].ToString(), txtOrderNo.Text.Trim(), txtDescription.Text.Trim(), "insert" };
                                    res = res + QueryExecution.ExeData("SP", "[DBT].[SP@SchemeTargetRelease2122]", par, parval, "kkisanconstr");

                                }
                                else
                                {
                                    lblNotMsg.Text = " ADA Physical Targets Release for SCP Should be less than JDA Physical Target Release for SCP ! ";
                                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "showNotModal();", true);
                                    BindSchemeReleaseTransactionList();
                                }
                            }
                            ...
                            {
                                lblNotMsg.Text = " ADA Targets Release Amount for SCP Should be less than JDA Target Release Amount for SCP! ";
                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "showNotModal();", true);
                                BindSchemeReleaseTransactionList();
                            }
                        }
                        if (txtPhysicalTarget2.Text != "" && txtFinancialTarget2.Text != "")
                        {
                            ...
                            if (HOAAmount_New2 >= Convert.ToDouble(String.Format("{0:0.000}", (JDAAmount_New2 + Release_New2))))
                            {
                                if (HOAPhysical_New2 >= Convert.ToDouble(String.Format("{0:0.000}", (JDAPhysical_New2 + ReleasePhysical_New2))))
                                {
                                    ...
                                    string[] par = { "@ApplicationID", "@FinancialYearID", "@MainSchemeID", "@SchemeID", "@CropID", "TechnologyID", "CategoryID", "@DistrictID", "@TalukID", "@HobliID", "@PhysicalTarget", "@FinancialTarget", "@ReleasedBy", "@OrderNo", "@Description", "@Method" };
                                    string[] parval = { ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue, ddlSubScheme.SelectedValue, ddlCrop.SelectedValue, ddlTechnology.SelectedValue, ddlCategory2.SelectedValue, ddlDistrict.SelectedValue, ddlTaluk.SelectedValue, ddlHobli.SelectedValue, txtPhysicalTarget2.Text.Trim(), txtFinancialTarget2.Text.Trim(), Session["RoleID"].ToString(), txtOrderNo.Text.Trim(), txtDescription.Text.Trim(), "insert" };
                                    res = res + QueryExecution.ExeData("SP", "[DBT].[SP@SchemeTargetRelease2122]", par, parval, "kkisanconstr");
                                }
                                else
                                {
                                    lblNotMsg.Text = " ADA Physical Targets Release for TSP Should be less than JDA Physical Target Release for TSP ! ";
                                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "showNotModal();", true);
                                    BindSchemeReleaseTransactionList();
                                }
                            }
                            ...
                            {
                                lblNotMsg.Text = " ADA Targets Release for TSP Amount Should be less than JDA Target Release Amount for TSP ! ";
                                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "showNotModal();", true);
                                BindSchemeReleaseTransactionList();
                            }
                        }
        ...
        private void BindTechnologies()
        {
            ...
            else
            {
                ...
                ddlTechnology.Items.Insert(0, li1);
                ListItem li = new ListItem("Seed Mini Kit", "1000");
                ddlTechnology.Items.Insert(1, li);
        ...
        private void BindSectorwiseScheme()
        {
            try
            {
                string str = ConfigurationManager.ConnectionStrings["kkisanconstr"].ToString();
                SqlConnection con = new SqlConnection(str);
                string com = "select SchemeID as ValueField,SchemeNameEng as ItemField from Master.MasterSectorScheme where ApplicationID='" + ApplicationID + "' and FinancialYearID='" + Convert.ToInt32(ddlFinancialYear.SelectedValue) + "'";
        ...
        public void BindSchemeReleaseTransactionList()
        {
            try
            {
                if (ddlFinancialYear.SelectedValue != "0" && ddlScheme.SelectedValue != "0" && ddlDistrict.SelectedValue != "0" && ddlTaluk.SelectedValue != "0" && ddlHobli.SelectedValue != "0")
                {
                    DataTable dt = new DataTable();
                    ...
                    string[] parval = { ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue, ddlSubScheme.SelectedValue, ddlCrop.SelectedValue, ddlTechnology.SelectedValue, ddlCategory.SelectedValue, ddlDistrict.SelectedValue, ddlTaluk.SelectedValue, ddlHobli.SelectedValue, Session["RoleID"].ToString(), "E" };
                    ...
                    string[] parval1 = { ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue, ddlSubScheme.SelectedValue, ddlCrop.SelectedValue, ddlTechnology.SelectedValue, ddlCategory1.SelectedValue, ddlDistrict.SelectedValue, ddlTaluk.SelectedValue, ddlHobli.SelectedValue, Session["RoleID"].ToString(), "E" };
                    ...
                    string[] parval2 = { ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue, ddlSubScheme.SelectedValue, ddlCrop.SelectedValue, ddlTechnology.SelectedValue, ddlCategory2.SelectedValue, ddlDistrict.SelectedValue, ddlTaluk.SelectedValue, ddlHobli.SelectedValue, Session["RoleID"].ToString(), "E" };
        ...
        public void IsTargetsExists()
        {
            try
            {
                ...
                TargetRelese2122 target = dbt.GetTargetRelease(ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue, ddlSubScheme.SelectedValue, ddlCrop.SelectedValue, ddlTechnology.SelectedValue, ddlCategory.SelectedValue, ddlDistrict.SelectedValue, ddlTaluk.SelectedValue, ddlHobli.SelectedValue, Session["RoleID"].ToString());
                TargetRelese2122 target1 = dbt.GetTargetRelease(ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue, ddlSubScheme.SelectedValue, ddlCrop.SelectedValue, ddlTechnology.SelectedValue, ddlCategory1.SelectedValue, ddlDistrict.SelectedValue, ddlTaluk.SelectedValue, ddlHobli.SelectedValue, Session["RoleID"].ToString());
                ...
                //DataTable dt = new DataTable();
                //string[] par = { "@ApplicationID", "@FinancialYearID", "@MainSchemeID", "@SchemeID", "@CropID", "TechnologyID", "CategoryID", "@DistrictID", "@TalukID", "@HobliID", "@RoleID" };
                //string[] parval = { ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue, ddlSubScheme.SelectedValue, ddlCrop.SelectedValue, ddlTechnology.SelectedValue, ddlCategory.SelectedValue, ddlDistrict.SelectedValue, ddlTaluk.SelectedValue, ddlHobli.SelectedValue, Session["RoleID"].ToString() };
                //dt = QueryExecution.DataAdapt("SP", "[DBT].[SP@IsExistSchemeTargetRelease2122]", par, parval, "kkisanconstr");
                //if (dt.Rows.Count == 1)
                //{
                //    Clear();
                //    txtOrderNo.ReadOnly = true;
        ...
        protected void grdReleasedList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "DELETE_")
                {
                    ...
                    ViewState["hdnHobliID"] = ((HiddenField)grdReleasedList.Rows[IndexValue].FindControl("hdnHobliID")).Value.ToString().Trim();
        ...
        protected void ddlHobli_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                lblPhysicalTarget1.Text = ddlHobli.SelectedItem.Text;
                lblPhysicalTarget2.Text = ddlHobli.SelectedItem.Text;
        ...
        public void Filldata()
        {
            try
            {
                ...
                lblTotalReleasedAmount.Text = (Convert.ToDouble(amount) - Convert.ToDouble(Common.TotalTargetReleaseAmountDBT2122(ApplicationID, Convert.ToInt32(ddlFinancialYear.SelectedValue), Convert.ToInt32(ddlScheme.SelectedValue), Convert.ToInt32(ddlSubScheme.SelectedValue), Convert.ToInt32(ddlCrop.SelectedValue), Convert.ToInt32(ddlTechnology.SelectedValue), Convert.ToInt32(ddlCategory.SelectedValue), Convert.ToInt32(ddlDistrict.SelectedValue), Convert.ToInt32(ddlTaluk.SelectedValue), Convert.ToInt32(ddlHobli.SelectedValue), Convert.ToInt32(Session["RoleID"].ToString()), "kkisanconstr").ToString())).ToString();
                ...
                lblTotalReleasedAmount1.Text = (Convert.ToDouble(amount1) - Convert.ToDouble(Common.TotalTargetReleaseAmountDBT2122(ApplicationID, Convert.ToInt32(ddlFinancialYear.SelectedValue), Convert.ToInt32(ddlScheme.SelectedValue), Convert.ToInt32(ddlSubScheme.SelectedValue), Convert.ToInt32(ddlCrop.SelectedValue), Convert.ToInt32(ddlTechnology.SelectedValue), Convert.ToInt32(ddlCategory1.SelectedValue), Convert.ToInt32(ddlDistrict.SelectedValue), Convert.ToInt32(ddlTaluk.SelectedValue), Convert.ToInt32(ddlHobli.SelectedValue), Convert.ToInt32(Session["RoleID"].ToString()), "kkisanconstr").ToString())).ToString();
