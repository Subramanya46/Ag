<%@ Page Title="" Language="C#" MasterPageFile="~/Application.master" EnableEventValidation="false" AutoEventWireup="true" Inherits="Kisan.Demonstration.NFSMPhysicalTargets" CodeBehind="NFSMPhysicalTargets.aspx.cs" %>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <asp:DropDownList ID="ddlFinancialYear" class="form-control" runat="server" OnSelectedIndexChanged="ddlfinancial_SelectedIndexChanged" AutoPostBack="true">
                                                </asp:DropDownList>
                                     ...
                                     <div class="col-md-2">
                                        <label for="email_address">Scheme Name <span class="star_color">*</span> </label>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <asp:DropDownList ID="ddlschemes" class="form-control" runat="server" OnSelectedIndexChanged="ddlschemes_SelectedIndexChanged" AutoPostBack="true">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row clearfix" runat="server" id="divDCBill">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card card_top">
                        <div class="header header_padding">
                            <h2 class="heading_padding">
                                <span class="scheme_master">NFSM Physical Target Details </span>
                            </h2>
                        </div>
                        <div class="body scheme_body">
                            <div class="demo-masked-input">
                                                ...
                                                <Columns>
                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                                                      ...
                                                      <asp:TemplateField HeaderText="Scheme Name" ItemStyle-HorizontalAlign="center">
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" ID="lblSchemeName" Text='<%# Eval("SchemeName") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Physical Target(Hec)" ItemStyle-HorizontalAlign="center">
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" ID="lblTargetReleased" Text='<%# Eval("PhysicalTarget") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="FinancialTarget(Rs) " ItemStyle-HorizontalAlign="center">
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" ID="lblTargetAchieved" Text='<%# Eval("FinancialTarget") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
