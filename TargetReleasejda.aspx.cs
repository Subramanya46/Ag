...
{
    public partial class TargetReleasejda : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (Page.IsValid == true && ValidateForm() == 1)
                {
                    ...
                    if (btnGo.Text=="Update")
                    {
                        ...
                        string[] parval = { ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue.ToString().Trim(), ddlDistrict.SelectedValue, ddlTaluk.SelectedValue, "0", txtPhysicalTarget.Text.Trim(), txtFinancialTarget.Text.Trim(), Session["RoleID"].ToString(), txtOrderNo.Text.Trim(), txtDescription.Text.Trim(), "Update" };
                    ...
                    else
                    {
                        if (HOAAmount_New >= (JDAAmount_New + Release_New))
                        {
                            ...
                            string[] par = { "@ApplicationID", "@FinancialYearID", "@SchemeID", "@DistrictID", "@TalukID", "@HobliID", "@PhysicalTarget", "@FinancialTarget", "@ReleasedBy", "@OrderNo", "@Description", "@Method" };
                            string[] parval = { ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue.ToString().Trim(), ddlDistrict.SelectedValue, ddlTaluk.SelectedValue, "0", txtPhysicalTarget.Text.Trim(), txtFinancialTarget.Text.Trim(), Session["RoleID"].ToString(), txtOrderNo.Text.Trim(), txtDescription.Text.Trim(), "insert" };
                            int res = QueryExecution.ExeData("SP", "[DBT].[SP@SchemeTargetRelease]", par, parval, "kkisanconstr");
                            if (res >= 1)
                            {
                                Clear();
        ...
        public void BindSchemeReleaseTransactionList()
        {
            try
            {
                if (ddlFinancialYear.SelectedValue != "0" && ddlSector.SelectedValue != "0" && ddlScheme.SelectedValue != "0" && ddlDistrict.SelectedValue != "0" && ddlTaluk.SelectedValue != "0")
                {
                    ...
                    string[] parval = { ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue.ToString().Trim(), ddlDistrict.SelectedValue, ddlTaluk.SelectedValue,"0", Session["RoleID"].ToString(), "E" };
        ...
        public void IsTargetsExists()
        {
            try
            {
                ...
                string[] parval = { ApplicationID, ddlFinancialYear.SelectedValue.ToString().Trim(), ddlScheme.SelectedValue.ToString().Trim(), ddlDistrict.SelectedValue, ddlTaluk.SelectedValue,"0", Session["RoleID"].ToString() };
